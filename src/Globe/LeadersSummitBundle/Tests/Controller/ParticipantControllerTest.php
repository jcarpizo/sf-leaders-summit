...
namespace Globe\LeadersSummitBundle\Tests\Controller;
...
class ParticipantControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'globe_leaderssummitbundle_participant[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Update')->form(array(
            'globe_leaderssummitbundle_participant[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
